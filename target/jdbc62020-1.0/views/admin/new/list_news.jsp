											...
											<div class="dt-buttons btn-overlap btn-group">
												<a flag="info"
												   ...
												   title='Thêm bài viết' href='<c:url value="/admin-new?type=edit"/>'>
														<%-- url khong co id nen la Add new	--%>
														<span>
									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											...
											<ul class="pagination" id="pagination"></ul>
											 ...
											 <!-- name trùng với filed trong model -->
		...
		<script type="text/javascript">
            ...
            $( "#btnDelete" ).click(function() {
				...
				var ids = $('tbody input[type=checkbox]:checked').map(function () {
					return $(this).val();
				}).get(); 							/*Lấy ID NHỮNG TH ĐƯỢC CHECKED GỬI VÀO ids*/
				data['ids'] = ids; 					/*data['ids'] là fiels của abstractmodel là model.ids*/
				deleteNew(data);
			});
